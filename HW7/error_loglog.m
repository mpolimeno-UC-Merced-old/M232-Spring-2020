...
title('log-log plot of errors vs. h','interpreter','latex')
...
err1 = exp(K)*h.^p;
loglog(h,err1,'r-')
legend('Errors', 'Least Squares Fit','interpreter','latex','Location','SouthEast')
grid on
xlabel('$h$','interpreter','latex','fontsize',15)
ylabel('$\mid{u_{n}-u(x,t)}\mid$','interpreter','latex','fontsize',15)
hold off
