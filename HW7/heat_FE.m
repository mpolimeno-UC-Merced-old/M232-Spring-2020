...
%     end
    ...
    legend('Forward Euler','Analytical','interpreter','latex')
    ...
    for n = 1:nsteps
        ...
        g0n = u(1); %this is the initial condition at my first spatial grid point
        g1n = u(m+2); %initial condition at my last spatial grid point
        g0np = utrue(ax,tnp); %this are the boundary conditions
        g1np = utrue(bx,tnp);
        ...
        rhs(1) = rhs(1) + r*(g0n); %this is the only part I am not fully sure about
        rhs(m) = rhs(m) + r*(g1n);
